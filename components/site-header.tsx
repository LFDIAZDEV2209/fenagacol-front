    ...
    <header className={`w-full ${minimal ? "bg-white border-b border-[#ece2d1]" : "bg-transparent"}`}>
      <div className="mx-auto max-w-[1160px] px-4 sm:px-6 h-[64px] flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-xl bg-[#6b1220] flex items-center justify-center text-white font-black text-[13px] tracking-tight">TG</div>
        ...
        <nav className="hidden sm:flex items-center gap-2">
          <Link href="/registro" className="px-4 py-2 rounded-full bg-[#6b1220] text-white text-sm font-semibold hover:bg-[#7e1730] transition-colors">
            Registrarse
          </Link>
        ...
        <Link href="/login" className="sm:hidden w-9 h-9 rounded-full bg-white border border-[#e8ddd0] grid place-items-center text-[#6b1220]">
